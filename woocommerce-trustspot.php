<?php
/*
Plugin Name: TrustSpot For Woocommerce
Plugin URI: https://trustspot.io
Description: Collect and display product and company reviews through TrustSpot
Author: TrustSpot
Author URI: https://trustspot.io
Version: 1.1
Text Domain: woocommerce-trustspot
*/
if ( ! defined( 'ABSPATH' ) ) {
...
function trustspot_verify_account() {
    $verifyUrl = "https://trustspot.io/api/merchant/verify_api_woocommerce";
...
{
    $trustspot_options = get_option('trustspot_options');
    wp_enqueue_style( 'trustspot_widget_css', 'https://trustspot.io/index.php/api/pub/product_widget_css/'.$trustspot_options['trustspot_trustspot_client_id'].'/widget.css' );
    wp_enqueue_style( 'trustspot_font_css', 'https://trustspot.io/assets/css/font-awesome.min.css' );
    wp_enqueue_script('trustspot_reviews_js', 'https://trustspot.io/assets/js/trustspot_product_reviews.js', array(), null, false);
}
